...
const kovanOrganizerAddr = "0xA62DeB0e07B2557ad5E3282F158F6Ff0f348EC97";


module.exports = async function(deployer) {
  /*
  tokenInstance = await ERC20.at(kovanAaveAUSDCAddr);
  ...
  console.log('got variance instance')
  ...
  console.log('my ape you have sucessfully swung through the jungle');
  */
}
